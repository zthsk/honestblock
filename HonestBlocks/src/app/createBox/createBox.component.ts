...
export class createBoxComponent implements OnInit {
  ...
  medicineContained = new FormControl('', Validators.required);
  quantityProvided = new FormControl('', Validators.required);
  ...
  constructor(private servicecreateBox: createBoxService, fb: FormBuilder) {
    this.myForm = fb.group({
      ...
      status: this.status,
      medicineContained: this.medicineContained,
  ...
  addTransaction(form: any): Promise<any> {
    this.Transaction = {
      ...
      'medicineContained': this.medicineContained.value,
      'quantityProvided': this.quantityProvided.value,
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.medicineContained) {
        formObject.medicineContained = result.medicineContained;
      } else {
        formObject.medicineContained = null;
      }

      if (result.quantityProvided) {
        formObject.quantityProvided = result.quantityProvided;
      } else {
        formObject.quantityProvided = null;
      }
